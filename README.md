...
- **实战技术卡**：[`techniques/`](./techniques/) — 39 张 YAML 技术卡，含触发信号/payload/判据
- **深度专题**：[`references/`](./references/) — 10 个专题 57 篇文档
- **知识蒸馏**：[`knowledge/`](./knowledge/) — 17 个分类 131+ 条目，另含 4 个框架漏洞库
- **案例复盘**：[`cases/`](./cases/) — 14 个攻防案例（含 20260803 RuoYi 博彩、20260804 预测平台系、20260806 六合彩站复测、20260730 USDT 假充值）
