...
当前收录 **14 类漏洞索引（150+条目）、22 张技术卡（11类）和 3 份案例**，内容面向网络渗透学习、授权安全评估与复盘。
...
| **Techniques** | SQLi(5)、IDOR(2)、Pwn(1)、JWT(3)、SSRF(3)、SSTI(2)、命令注入(3)、请求走私(2)、反序列化(2)、XSS(2) | 25 张 | [技术卡目录](./techniques/) |
| **Cases** | CTF 与 Pwn 案例记录 | 3 份 | [案例目录](./cases/) |
