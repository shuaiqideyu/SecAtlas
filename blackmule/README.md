...
当前收录 14 类漏洞索引、8 张技术卡和 3 份案例，内容面向网络渗透学习、授权安全评估与复盘。

## 内容结构

| 分区 | 内容 | 入口 |
| --- | --- | --- |
| **Knowledge Base** | SQLi、XSS、SSRF、文件包含、命令注入、反序列化、SSTI、JWT、OAuth、请求走私、访问控制、IDOR、Pwn 与综合技巧 | [知识总索引](./knowledge-base/MASTER_INDEX.md) |
| **Techniques** | SQLi、IDOR 与 Pwn 可复用技术卡 | [技术卡目录](./techniques/) |
| **Cases** | CTF 与 Pwn 案例记录 | [案例目录](./cases/) |
